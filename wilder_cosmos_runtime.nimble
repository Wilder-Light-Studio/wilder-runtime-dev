...
task testCompile, "Compile-check current test stubs":
	...
	exec "nim c --compileOnly tests/validation_firewall_test.nim"
	exec "nim c --compileOnly tests/validation_firewall_perf_test.nim"
...
task test, "Run all tests":
	...
	exec "nim c -r tests/validation_firewall_test.nim"
	exec "nim c -r tests/validation_firewall_perf_test.nim"
